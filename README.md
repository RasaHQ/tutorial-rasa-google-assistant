...
The best way to use this repository is by following a step-by-step tutorial on how to integrate the Rasa assistant to Google Assistant. If you choose to use a Place Finder assistant to follow the tutorial, you can find the installation instructions and requirements.txt file inside the **place-finder** directory of this repository.
